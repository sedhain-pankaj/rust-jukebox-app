 ...
 */ (function () {
...
})()(
  {
    ...
    7: [
        ...
        var MediaElement = function MediaElement(idOrNode, options, sources) {
          ...
          var props = _mejs2.default.html5media.properties,
            ...
            setSrc = function setSrc(value) {
              ...
              var shouldChangeRenderer = !(
                mediaFiles[0].src == null || mediaFiles[0].src === ""
              );
              ...
              t.mediaElement[methodName] = function () {
                ...
                if (
                  ...
                  if (t.mediaElement.promises.length) {
                    return Promise.all(t.mediaElement.promises)
                      .then(function () {
      ...
      { 2: 2, 26: 26, 28: 28, 3: 3, 30: 30, 8: 8, 9: 9 },
    ],
    8: [
      function (_dereq_, module, exports) {
        "use strict";
    ...
    10: [
        ...
        Object.assign(_player2.default.prototype, {
          ...
          buildfullscreen: function buildfullscreen(player) {
            ...
            fullscreenBtn.className =
              ...
              t.options.classPrefix +
              "fullscreen-button";
            fullscreenBtn.innerHTML = (0, _generate.generateControlButton)(
              t.id,
              fullscreenTitle,
              fullscreenTitle,
              "" + t.media.options.iconSprite,
          ...
          enterFullScreen: function enterFullScreen() {
            ...
            if (
              ...
              (Features.IS_IOS || Features.IS_SAFARI) &&
      ...
      { 17: 17, 2: 2, 26: 26, 27: 27, 28: 28, 29: 29, 3: 3, 30: 30, 6: 6 },
    ],
    11: [
      function (_dereq_, module, exports) {
        "use strict";
        ...
        Object.assign(_player2.default.prototype, {
          buildplaypause: function buildplaypause(
            ...
            play.className =
              ...
              t.options.classPrefix +
              "play";
            play.innerHTML = (0, _generate.generateControlButton)(
              t.id,
              pauseTitle,
              playTitle,
              "" + t.media.options.iconSprite,
      ...
      { 17: 17, 2: 2, 27: 27, 28: 28, 29: 29, 6: 6 },
    ],
    12: [
      function (_dereq_, module, exports) {
        "use strict";
      ...
      { 17: 17, 2: 2, 26: 26, 27: 27, 32: 32, 6: 6 },
    ],
    13: [
      function (_dereq_, module, exports) {
        "use strict";
    ...
    14: [
      function (_dereq_, module, exports) {
        ...
        Object.assign(_player2.default.prototype, {
          ...
          buildtracks: function buildtracks(player, controls, layers, media) {
            ...
            player.captionsButton.innerHTML =
              (0, _generate.generateControlButton)(
                t.id,
                tracksTitle,
                tracksTitle,
                "" + t.media.options.iconSprite,
        ...
        _mejs2.default.TrackFormatParser = {
          ...
          dfxp: {
            parse: function parse(trackText) {
              var trackElem = _document2.default.adoptNode(
                  new DOMParser().parseFromString(trackText, "application/xml")
                    .documentElement,
                ),
                container = trackElem.querySelector("div"),
                lines = container.querySelectorAll("p"),
                styleNode = _document2.default.getElementById(
              ...
              for (
                ...
                _temp.text = lines[_i16].innerHTML
                  .trim()
                  .replace(
                    /(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_| !:, .; ]*[-A-Z0-9+&@#\/%=~_|])/gi,
                    "<a href='$1' target='_blank'>$1</a>",
      ...
      { 17: 17, 2: 2, 27: 27, 28: 28, 29: 29, 32: 32, 6: 6, 8: 8 },
    ],
    15: [
      function (_dereq_, module, exports) {
        "use strict";
        ...
        Object.assign(_player.config, {
          ...
          //use value of id=vol to set volume divided by 100
          startVolume: $("#vol").html() / 100,
        });
      ...
      { 17: 17, 2: 2, 26: 26, 27: 27, 28: 28, 29: 29, 6: 6 },
    ],
    16: [
      function (_dereq_, module, exports) {
        "use strict";
          ...
          _createClass(MediaElementPlayer, [
            ...
            },
            {
              ...
              value: function init() {
                ...
                if (
                  t.getElement(t.container) !== undefined &&
                  t.options.features.length &&
                  t.controlsAreVisible &&
            ...
            },
            {
              ...
              value: function buildoverlays(player, controls, layers, media) {
                ...
                bigPlay.className =
                  ...
                  t.options.classPrefix +
                  "overlay-play";
                bigPlay.innerHTML = (0, _generate.generateControlButton)(
                  t.id,
                  _i18n2.default.t("mejs.play"),
                  _i18n2.default.t("mejs.play"),
                  "" + t.media.options.iconSprite,
    ...
    20: [
      ...
      { 26: 26, 27: 27, 28: 28, 3: 3, 30: 30, 8: 8, 9: 9 },
    ],
    21: [
      function (_dereq_, module, exports) {
        "use strict";
      ...
      { 2: 2, 26: 26, 28: 28, 3: 3, 30: 30, 6: 6, 8: 8, 9: 9 },
    ],
    22: [
      function (_dereq_, module, exports) {
        "use strict";
    ...
    25: [
      function (_dereq_, module, exports) {
        ...
        var YouTubeIframeRenderer = {
          ...
          create: function create(mediaElement, options, mediaFiles) {
            ...
            //add sandbox to the container
            youtubeContainer.setAttribute(
              "sandbox",
              "allow-pointer-lock allow-scripts allow-same-origin",
            );

            //add pointer events to the container
            youtubeContainer.setAttribute("style", "pointer-events:none;");
      ...
      { 2: 2, 27: 27, 28: 28, 3: 3, 30: 30, 8: 8, 9: 9 },
    ],
    26: [
      function (_dereq_, module, exports) {
        "use strict";
        ...
        var SUPPORT_PASSIVE_EVENT = (exports.SUPPORT_PASSIVE_EVENT =
          (function () {
    ...
    29: [
      function (_dereq_, module, exports) {
        ...
        function generateControlButton(
          playerId,
          ariaLabel,
          title,
          iconSprite,
    ...
    30: [
      function (_dereq_, module, exports) {
        ...
        function getTypeFromFile(url) {
          ...
          if (normalizedExt) {
            if (
              ~["mp4", "m4v", "ogg", "ogv", "webm", "flv", "mpeg"].indexOf(
                normalizedExt,
              )
            ) {
